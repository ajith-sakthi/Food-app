    ...
    return (
      <div className="text-center mt-6">
        <h1 className="text-xl">
          Hey,looks like you're offline check your wifi or internet connection!!
        </h1>
      </div>
    );
  }
      ...
      <div className="flex justify-center my-4">
        <div className="">
          <input
            ...
            className="border-2 w-60 border-black rounded-md"
            type="text"
            value={searchValue}
            onChange={(sVal) => {
          ...
          <button
            className="ml-2 px-2 py-1  bg-indigo-300 rounded-lg hover:bg-indigo-400"
            onClick={() => {
        ...
        <div className="ml-4">
          <button
            className="px-2 py-1 bg-indigo-300 rounded-lg hover:bg-indigo-400"
            onClick={() => {
