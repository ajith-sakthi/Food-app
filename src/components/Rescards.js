...
const Rescards = (props) => {
  ...
  return (
    <div
      data-testid="testCards"
      className="w-80 h-[450px] p-2 m-2 bg-indigo-100 hover:bg-indigo-200 rounded-lg"
    >
      <img
...
export const withPromotedcard = (Rescards) => {
  return (props) => {
    return (
      <div>
        <label className="absolute p-2 bg-black-100 text-white rounded-md">
          Promoted
        </label>
        <Rescards {...props} />
      </div>
